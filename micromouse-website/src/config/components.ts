...
export const componentDefinitions: ComponentDefinition[] = [
  ...
  },
  {
    ...
    description: 'Measures the wall to the robot\'s left along the positive ninety-degree axis using infrared light and spatial filtering.',
    accent: '#45e6ff',
  ...
  },
  {
    ...
    shortLabel: 'TOF 0',
    electronicName: 'VL6180X',
    description: 'Measures the wall directly ahead along the robot\'s zero-degree forward axis using infrared light and spatial filtering.',
    accent: '#45e6ff',
  ...
  },
  {
    ...
    shortLabel: 'TOF -90',
    electronicName: 'VL6180X',
    description: 'Measures the wall to the robot\'s right along the negative ninety-degree axis using infrared light and spatial filtering.',
    accent: '#45e6ff',
    explodeOffset: [0.82, 0, -0.2],
  },
  {
